...
public class SwimmingState extends SimpleExpression<Boolean> {

    static {
        Skript.registerExpression(SwimmingState.class, Boolean.class, ExpressionType.PROPERTY,
    ...
    protected Boolean[] get(Event event) {
        ...
        if (p != null) {
            return new Boolean[]{p.isSwimming()};
        }
        return null;
    }
    ...
    public String toString(@Nullable Event event, boolean debug) {
        return "swim state of " + player.toString(event, debug);
    }
}